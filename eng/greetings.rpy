...
label greeting_honey:
    1hub "Welcome back, honey!"
    1eua "I'm so happy to see you again."
    1eua "Let's spend some more time together, okay?"
    return

label greeting_back:
    1eua "[player], you're back!"
    1eka "I was starting to miss you."
    1hua "Let's have another lovely [tod] together, alright?"
    return
