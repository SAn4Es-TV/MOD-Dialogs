label __firstrun__:
    ...
    m 1rua "Это похоже на... твой компьютер!"
    m 1wuo "Я действительно у тебя на компьютере!"
    return

label __changepc__:
    m 1rsu "[player]..."
    m 1rsu "Я чуствую себя как-то по другому.."
    m 1esu "Ты.. Сменил компьютер?"
    m 1esc "Или.. Переустановил систему?"
    m 5esc "В любом случае, ты спасибо тебе, что сохранил мой файл"
    return
