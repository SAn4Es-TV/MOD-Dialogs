...
label monika_selfesteem:
    ...
    menu:
        "Да.":
            jump monika_selfesteem_1
        "Нет.":
            jump monika_selfesteem_2
    return

label monika_selfesteem_1:
...
label monika_sayori:
    ...
    menu:
        "Да, я хотел бы.":
            jump monika_sayori_1
        "Не стоит.":
            jump monika_sayori_2
    return

label monika_sayori_1:
    ...
    jump monika_sayori_3

label monika_sayori_2:
    m "Я понимаю, [player]."
    jump monika_sayori_3

label monika_sayori_3:
    m 2euc "Тем не менее..."
...
label monika_introvert:
    ...
    menu:
        "Да.":
            jump monika_introvert_1
        "Нет.":
            jump monika_introvert_2
    return

label monika_introvert_1:
...
label monika_horror:
    ...
    menu:
        "Да.":
            jump monika_horror_1
        "Нет.":
            jump monika_horror_2
    return

label monika_horror_1:
    m 1sub "О, ты смелый!"
...
label monika_twitter:
    ...
    m 3esc "Мой ник [mas_monika_twitter_handle]."
...
label monika_bestfriend:
    ...
    menu:
        "Да, есть.":
            jump monika_bestfriend_1
        "Нет, я одиночка.":
            jump monika_bestfriend_2
    return

label monika_bestfriend_1:
...
label monika_reading:
    ...
    menu:
        "Бумажные.":
            jump monika_reading_1
        "Электронные.":
            jump monika_reading_2
    return

label monika_reading_1:
...
label monika_weather:
    ...
    menu:
        "Солнечно.":
            jump monika_weather_1
        "Идет дождь/снег.":
            jump monika_weather_2
    return

label monika_weather_1:
...
label monika_future:
    ...
    menu:
        "Да, у меня есть четкий план.":
            jump monika_future_1
        "Нет, я живу сегодняшним днем.":
            jump monika_future_2
    return

label monika_future_1:
...
label monika_morning_person:
    ...
    menu:
        "Жаворонок (люблю утро).":
            jump monika_morning_person_1
        "Сова (люблю ночь).":
            jump monika_morning_person_2
    return
...
label monika_player_social:
    ...
    menu:
        "Да, я очень общительный.":
            jump monika_player_social_1
        "Нет, мне это даётся с трудом.":
            jump monika_player_social_2
    return

label monika_player_social_1:
    m 1hub "Это здорово!"
...
label monika_technology:
    ...
    menu:
        "Да, это естественный прогресс.":
            jump monika_technology_1
        "Нет, это может быть опасно.":
            jump monika_technology_2
    return

label monika_technology_1:
...
label monika_comfort_food:
    ...
    menu:
        "Да, сладости.":
            jump monika_comfort_food_1
        "Что-то сытное (пицца, бургеры).":
            jump monika_comfort_food_2
    return

label monika_comfort_food_1:
...
label monika_perfection:
    ...
    menu:
        "Да, это про меня.":
            jump monika_perfection_1
        "Нет, я более расслаблен в этом плане.":
            jump monika_perfection_2
    return

label monika_perfection_1:
...
label monika_travel:
    ...
    menu:
        "На природу.":
            jump monika_travel_1
        "В большой город.":
            jump monika_travel_2
    return

label monika_travel_1:
